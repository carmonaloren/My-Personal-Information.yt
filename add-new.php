...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `myinfo`(`id`, `first_name`,`middle_name`,`last_name`, `email`, `gender`) VALUES (NULL,'$first_name','$middle_name','$last_name','$email','$gender')";
      ...
      <div class="container d-flex justify-content-center">
         <form action="" method="post" style="width:50vw; min-width:300px;">
            <div class="row mb-3">
               ...
               <div class="col">
                  <label class="form-label">Midle Name</label>
